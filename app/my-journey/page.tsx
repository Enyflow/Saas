...
const Profile =async () => {
    ...
    return (
        ...
        <section className="flex justify-between gap-4 max-sm:flex-col intems-center">
            ...
            <Accordion type="multiple" >
                ...
                <AccordionContent>
                    <Companionslist title="My companions" companions={companions} ></Companionslist>
                </AccordionContent>
                </AccordionItem>
            </Accordion>
        </main>
